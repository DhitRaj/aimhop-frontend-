      ...
      <nav className={`bg-white dark:bg-[#111113] border-b border-[#E8E8E4] dark:border-[#1e1e24] sticky top-0 z-[100] transition-all duration-300 ${scrolled ? 'shadow-[0_1px_0_#E8E8E4,0_2px_20px_rgba(0,0,0,0.07)] dark:shadow-[0_1px_0_#1e1e24,0_2px_20px_rgba(0,0,0,0.3)]' : ''}`}>
        <div className="max-w-[1240px] mx-auto px-8 md:px-12 h-[68px] flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-2.5">
            ...
            <Link 
              href="/hire" 
              className="inline-flex items-center justify-center bg-[#2563EB] text-white font-semibold text-[14px] px-5 py-2.5 rounded-lg hover:bg-blue-700 transition-all duration-200"
            >
              Hire Staff
            </Link>
            <Link 
        ...
        <div className="flex flex-col h-full p-8">
          ...
          <div className="mt-auto space-y-4">
            <Link 
              href="/hire" 
              onClick={() => setMobileOpen(false)}
              className="w-full inline-flex items-center justify-center bg-[#2563EB] text-white font-semibold text-lg py-4 rounded-[14px] hover:bg-blue-700 transition-all duration-200"
            >
              Hire Staff
            </Link>
            <Link 
